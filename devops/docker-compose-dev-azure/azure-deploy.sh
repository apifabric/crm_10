...
resourcename="crm10"  # lower case, only
resourcegroup="crm10_rg"
...
# git clone https://github.com/apilogicserver/crm10.git
# cd crm10
...
az group create --name crm10_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group crm10_rg --sku S1 --is-linux
az container create --resource-group crm10_rg --name crm10 --image apilogicserver/crm10:latest --dns-name-label crm10 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//crm10.westus.azurecontainer.io:5656'
